...
export const AI_COMPUTE_DATA_VERSION = '20260809a'
export const AI_COMPUTE_LAST_UPDATED = 'August 9, 2026'
...
export const aiComputeData: AiComputeRow[] = [
  ...
  { buyer: 'OpenAI', provider: 'NVIDIA (equity + Vera Rubin)', amount: 'Up to $30B reported equity', amountBillions: 30, amountBasis: 'reported', capacity: '5 GW reported', capacityBasis: 'reported', term: '—', announced: 'Feb 2026', status: 'Reported / in talks', agreementType: 'equity investment', sources: [{ label: 'CNBC', url: 'https://www.cnbc.com/2026/02/19/nvidia-is-in-talks-to-invest-up-to-30-billion-in-openai-source-says.html', kind: 'supplemental reported' }], notes: 'Reported equity is not compute procurement and never enters the compute total.' },
  ...
  { buyer: 'Meta', provider: 'CoreWeave (Vera Rubin)', amount: '~$21B', amountBillions: 21, amountBasis: 'company-disclosed', capacity: 'AI cloud capacity; no comparable GW disclosed', capacityBasis: 'undisclosed', term: 'Through Dec 2032', announced: 'Aug 2026', status: 'Signed', agreementType: 'compute/cloud service', sources: [{ label: 'CoreWeave', url: 'https://www.coreweave.com/news/coreweave-and-meta-announce-21-billion-expanded-ai-infrastructure-agreement', kind: 'primary' }], notes: 'Cloud-service contract using NVIDIA systems; distinct from Meta–NVIDIA’s hardware partnership and not additive at the infrastructure layer.' },
