...
export const AI_COMPUTE_DATA_VERSION = '20260823a'
export const AI_COMPUTE_LAST_UPDATED = 'August 23, 2026'
...
export const aiComputeData: AiComputeRow[] = [
  ...
  { buyer: 'OpenAI', provider: 'SB Energy / NVIDIA (PORTS-Pike, Ohio)', amount: 'Undisclosed', amountBasis: 'undisclosed', capacity: '4.25 IT-GW initial; approximately 3.75–3.8 IT-GW optional; OpenAI describes the overall agreement as approximately 8 IT-GW', capacityBasis: 'company-disclosed', term: '20-year lease, phased availability beginning 2028', announced: 'Aug 17, 2026', status: 'Signed', agreementType: 'compute/cloud service', sources: [{ label: 'OpenAI', url: 'https://openai.com/index/openai-joins-ports-pike-project/', kind: 'primary' }, { label: 'NVIDIA News', url: 'https://nvidianews.nvidia.com/news/nvidia-guarantees-sb-energy-s-ports-pike-technology-campus-in-ohio-to-exclusively-host-nvidia-ai-compute', kind: 'primary' }, { label: 'NVIDIA SEC 8-K (Aug 17, 2026)', url: 'https://www.sec.gov/Archives/edgar/data/1045810/000104581026000069/nvda-20260817.htm', kind: 'supplemental research' }], notes: 'NVIDIA\'s $105B figure is a conditional residual-value guarantee, not compute value or committed spend; it is not reflected in the compute value field. NVIDIA\'s $1.5B investment in SB Energy is a separate equity transaction. This row is not merged into the existing OpenAI–NVIDIA Vera Rubin row because overlap between the two agreements has not been ruled out.' },
