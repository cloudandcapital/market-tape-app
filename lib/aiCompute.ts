...
export const AI_COMPUTE_DATA_VERSION = '20260913a'
export const AI_COMPUTE_LAST_UPDATED = 'September 13, 2026'

export const aiComputeData: AiComputeRow[] = [
  { buyer: 'OpenAI', provider: 'AWS (Trainium)', amount: '$138B', amountBillions: 138, amountBasis: 'company-disclosed', capacity: 'Approximately 2 GW Trainium in expanded agreement', capacityBasis: 'company-disclosed', term: 'Expansion over 8 years', announced: 'Feb 27, 2026', status: 'Signed', agreementType: 'compute/cloud service', sources: [{ label: 'OpenAI — $100B expansion', url: 'https://openai.com/index/amazon-partnership/', kind: 'primary' }, { label: 'OpenAI — original $38B', url: 'https://openai.com/index/aws-and-openai-partnership/', kind: 'primary' }], notes: 'OpenAI says the existing $38B AWS compute agreement was expanded by $100B, not replaced by it. $138B combines the original agreement and incremental expansion once; Amazon’s separate $50B equity investment in OpenAI is excluded. Do not add the 2 GW expansion capacity to unrelated infrastructure targets.' },
  { buyer: 'OpenAI', provider: 'Firmus (Malaysia AI factories)', amount: 'Undisclosed', amountBasis: 'undisclosed', capacity: 'OpenAI allocation undisclosed', capacityBasis: 'undisclosed', term: 'Multiyear', announced: 'Sep 8, 2026', status: 'Announced', agreementType: 'compute/cloud service', sources: [{ label: 'Firmus', url: 'https://firmus.co/newsroom/firmus-surpasses-900-mw-contracted-capacity-adds-openai-as-anchor-customer-and-expands-into-malaysia', kind: 'primary' }], notes: 'Firmus and OpenAI announced a partnership under which OpenAI will contract capacity at two Malaysian sites. Firmus’s more than 900 MW is its entire contracted customer portfolio, not OpenAI-specific capacity; the release does not state that this particular contract has been executed.' },
  { buyer: 'Amazon', provider: 'Qualcomm (custom silicon / optical)', amount: 'Undisclosed', amountBasis: 'undisclosed', capacity: 'Undisclosed', capacityBasis: 'undisclosed', term: 'Multigenerational', announced: 'Sep 8, 2026', status: 'Signed', agreementType: 'hardware/chip partnership', sources: [{ label: 'Qualcomm', url: 'https://www.qualcomm.com/news/releases/2026/09/qualcomm-announces-multi-generational-product-collaboration-with', kind: 'primary' }, { label: 'Qualcomm SEC 8-K', url: 'https://d18rn0p25nwr6d.cloudfront.net/CIK-0000804328/40cf6f46-15e4-4ce9-8cf0-bb5c59529e44.pdf', kind: 'primary' }], notes: 'The SEC filing confirms an executed warrant and initial purchase commitments, but does not disclose their firm dollar value. Up to $60B is the warrant-linked maximum payment threshold, not a firm order or compute contract value; it is excluded.' },
  { buyer: 'Australian AI ecosystem', provider: 'NVIDIA Cloud Partners / DSX', amount: 'Undisclosed', amountBasis: 'undisclosed', capacity: 'Up to 2 GW by 2027 (ecosystem target)', capacityBasis: 'company-disclosed', term: 'Target by 2027', announced: 'Sep 9, 2026', status: 'Target', agreementType: 'infrastructure target', sources: [{ label: 'NVIDIA', url: 'https://nvidianews.nvidia.com/news/nvidia-expands-ai-infrastructure-capacity-in-partnership-with-australias-data-center-ecosystem', kind: 'primary' }], notes: 'Capacity is a multi-provider Australian infrastructure buildout target, not a signed customer allocation or additive contract value.' },
  { buyer: 'Unidentified customer', provider: 'SpaceX / xAI', amount: '$1.11B/month reported (run rate; total undisclosed)', amountBasis: 'reported', capacity: 'Undisclosed', capacityBasis: 'undisclosed', term: 'Undisclosed', announced: 'Sep 2026', status: 'Reported / in talks', agreementType: 'compute/cloud service', sources: [{ label: 'Business Insider', url: 'https://www.businessinsider.com/spacex-strikes-billion-a-month-compute-deal-with-mystery-customer-2026-9', kind: 'supplemental reported' }], notes: 'Counterparty and total contract value are unidentified. The monthly reported run rate is not annualized or included in the signed-dollar headline.' },
  ...
  { buyer: 'Anthropic', provider: 'Lambda (Texas / Nueces County)', amount: '~$35B reported', amountBillions: 35, amountBasis: 'reported', capacity: '~350 MW reported', capacityBasis: 'reported', term: 'Undisclosed', announced: 'Aug 31, 2026', status: 'Reported / in talks', agreementType: 'compute/cloud service', sources: [{ label: 'Reuters', url: 'https://www.reuters.com/technology/anthropic-signs-35-billion-cloud-deal-with-nvidia-backed-lambda-source-says-2026-08-31/', kind: 'supplemental reported' }], notes: 'Reuters reported that Anthropic signed for Lambda cloud capacity associated with a Nueces County, Texas data center and described Lambda as NVIDIA-backed. No first-party confirmation naming the parties was found; value, capacity, location, provider structure, and NVIDIA involvement remain reported and are excluded from the company-disclosed signed-dollar headline.' },
